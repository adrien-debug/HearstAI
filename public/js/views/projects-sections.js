                ...
                <table style="width: 100%; border-collapse: collapse;">
                    ...
                    <tbody>
                        <tr style="border-bottom: 1px solid rgba(197, 255, 167, 0.15);">
                            ...
                            <td style="padding: 10px; text-align: right;"><input type="number" style="width: 80px; background: rgba(26, 26, 26, 0.9); border: 1px solid rgba(197, 255, 167, 0.15); border-radius: 6px; padding: 6px; color: var(--text-primary); text-align: right;" value="100"></td>
                            <td style="padding: 10px; text-align: right;"><input type="number" style="width: 80px; background: rgba(26, 26, 26, 0.9); border: 1px solid rgba(197, 255, 167, 0.15); border-radius: 6px; padding: 6px; color: var(--text-primary); text-align: right;" value="0"></td>
                            <td style="padding: 10px; text-align: right;"><input type="number" style="width: 80px; background: rgba(26, 26, 26, 0.9); border: 1px solid rgba(197, 255, 167, 0.15); border-radius: 6px; padding: 6px; color: var(--text-primary); text-align: right;" value="1"></td>
                        </tr>
                        <tr>
                            <td style="padding: 10px; color: var(--text-primary);">Phase 2</td>
                            <td style="padding: 10px; text-align: right;"><input type="number" style="width: 80px; background: rgba(26, 26, 26, 0.9); border: 1px solid rgba(197, 255, 167, 0.15); border-radius: 6px; padding: 6px; color: var(--text-primary); text-align: right;" value="106"></td>
                            <td style="padding: 10px; text-align: right;"><input type="number" style="width: 80px; background: rgba(26, 26, 26, 0.9); border: 1px solid rgba(197, 255, 167, 0.15); border-radius: 6px; padding: 6px; color: var(--text-primary); text-align: right;" value="3"></td>
                            <td style="padding: 10px; text-align: right;"><input type="number" style="width: 80px; background: rgba(26, 26, 26, 0.9); border: 1px solid rgba(197, 255, 167, 0.15); border-radius: 6px; padding: 6px; color: var(--text-primary); text-align: right;" value="2"></td>
                        </tr>
                    </tbody>
                </table>

...
class ClaudeCockpitApp {
    constructor() {
        // Skip initialization in Next.js context
        // Check for Next.js indicators: Layout component, React root, or absence of legacy HTML structure
        const isNextJS = 
...
node server.js</pre>
    ...
    renderDashboard(data) {
        try {
            ...
            // Check if renderDashboard is available
                ...
                this.contentArea.innerHTML = `
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="text-secondary">renderDashboard is not available. Check console for details.</p>
                        </div>
                    </div>
                `;
                return;
            ...
            const template = renderDashboard(data || {});
...
document.addEventListener('DOMContentLoaded', () => {
    try {
        // Skip initialization if in Next.js context
        const isNextJS = 
            document.querySelector('#__next') || 
            document.querySelector('[data-nextjs-scroll-focus-boundary]') ||
            document.querySelector('.content-area-wrapper') || 
